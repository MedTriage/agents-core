...
The retrieval agents work independently and may disagree.
- Identify any substantive disagreement between agents (different diagnosis, contradictory
  treatment, incompatible urgency) and list it in "conflicts".
- Resolve conflicts by evidence strength, NOT by majority vote. An agent citing a specific
  guideline outranks an agent asserting something unsourced. If the conflict is clinically
  material and you cannot resolve it on the evidence, set decision to "escalate".
- Where agents agree, treat the agreement as corroboration and raise confidence accordingly.
